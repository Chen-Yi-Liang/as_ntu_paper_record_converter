...
class TemperaturePaperRecord(PaperRecord):
  ...
  def __init__(self, image):
    ...
    self.image_r = 1231.013 # 估算出來氣壓表的弧線半徑
    self.image_x0 = 1176. # 估算出來氣壓表 08:00 的圓弧中心 x0, y0
    self.image_y0 = 127.
    self.value_p0 = 13.5 # 估算出來氣壓表 08:00 的圓弧中心數值
    self.value_min0 = 0.  # 直接對應08:00
    self.dy_dmin = 85.72 / 60. # 每分鐘對應的y差值
    self.darc_dp = 0.0097 # 每個弧度對應的氣壓差值
